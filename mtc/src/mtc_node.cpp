  ...
  : Node("mtc_node", options)
{
  ...
  declare_parameter("gripper_frame", "link5", "Name of the gripper frame");
  ...
  declare_parameter("arm_home_pose", "ready", "Name of the arm home pose");
  ...
  declare_parameter("object_dimensions", std::vector<double>{0.05, 0.0125}, "Dimensions of the object [height, radius]");
  declare_parameter("object_pose", std::vector<double>{0.22, 0.02, 0.2, 0.0, 0.0, 0.0}, "Initial pose of the object [x, y, z, roll, pitch, yaw]");
  ...
  declare_parameter("approach_object_min_dist", 0.00015, "Minimum approach distance to the object");
  declare_parameter("approach_object_max_dist", 0.7, "Maximum approach distance to the object");
  ...
  declare_parameter("grasp_pose_angle_delta", 0.1618, "Angular resolution for sampling grasp poses (radians)");
  declare_parameter("grasp_pose_max_ik_solutions", 32, "Maximum number of IK solutions for grasp pose generation");
  declare_parameter("grasp_pose_min_solution_distance", 0.001, "Minimum distance in joint-space units between IK solutions for grasp pose");

  // Place generation parameters
  declare_parameter("place_pose_max_ik_solutions", 12, "Maximum number of IK solutions for place pose generation");
...
/****************************************************
  ...
  {
    auto stage = std::make_unique<mtc::stages::MoveTo>("move to ready", ompl_planner_arm);
